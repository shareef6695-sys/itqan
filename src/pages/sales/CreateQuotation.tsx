...
export const CreateQuotation: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Quotation Data:', { items, subtotal, total, terms });
    alert(t('sales.success.quotationCreated'));
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div className="flex items-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900">{t('sales.quotations.createTitle')}</h1>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white shadow rounded-lg p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">{t('sales.quotations.quotationDate')}</label>
            <input
              type="date"
              className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm border p-2 rtl:text-right"
              required
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">{t('sales.quotations.table.expiryDate')}</label>
            <input
              type="date"
              className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm border p-2 rtl:text-right"
              required
